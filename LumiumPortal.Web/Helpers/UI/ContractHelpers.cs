...
{
    public static Color GetStatusColor(ContractStatus status) =>
        status switch
        {
    ...
    public static string GetStatusText(ContractStatus status) =>
        status switch
        {
    ...
    public static string GetTypeText(ContractType type) =>
        type switch
        {
