...
public static class ClientHelpers
{
    ...
    public static Color GetStatusColor(ClientStatus status) => status switch
    {
    ...
    public static string GetStatusIcon(ClientStatus status) => status switch
    {
    ...
    public static Color GetSubStatusColor(ClientSubStatus subStatus) => subStatus switch
    {
    ...
    {
        return (status, subStatus) switch
        {
